...
$sql="SELECT * FROM `released_bodies` WHERE CONCAT(`id`, `name`) LIKE '%".$valuetosearch."%'"; 
$search_result= filtertable($sql);
}
else{
$sql="SELECT * FROM `released_bodies` ORDER BY `dr`";
$search_result=filtertable($sql);
...
<div class=" container pt-sm-4">
  <center class="text-uppercase text-primary h5" style="text-decoration: underline;">Released Bodies</center>
...
<tr>
      ...
      <th scope="col"><strong>DATE RELEASED</strong></th>
